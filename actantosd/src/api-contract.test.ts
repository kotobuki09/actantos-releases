...
const runtimeAndInMemoryRoutes = [
  ...
  { method: "GET", url: "/v1/approvals/channels" },
  { method: "PUT", url: "/v1/approvals/channels" },
  { method: "POST", url: "/v1/approvals/channels/notify" },
  { method: "POST", url: "/v1/approvals/channels/webhook/decide" },
